...
public class RegisterClothesRequest extends StringRequest {
    ...
    final static private String URL="pjclotheregister.php";
    private Map<String,String> parameters;

    public RegisterClothesRequest(String encoded_string, String image_name, String userID, String clothesWeather, String clothesType, String clothesDetailType, Response.Listener<String> listener)
    {
        ...
        Log.d("awdawd     ", clothesType);
        parameters.put("clothesWeather",clothesWeather);
