        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    Uri imageUriOut = Uri.parse("http://" + clothesImageAddressOut);
                    Uri imageUriUp = Uri.parse("http://" + clothesImageAddressUp);
                    Uri imageUriDown = Uri.parse("http://" + clothesImageAddressDown);
