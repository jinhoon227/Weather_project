    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clothesTypeGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                Log.d("usergg", userGender);
                Log.d("usercl", clothesType);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (encoded_string.equals("") || mImageCaptureName.equals("") || weather.equals("") || clothesType.equals("") ||  userGender.equals("")) {
                ...
                // mImageCaptureName 이미지 이름
                // userID 유저 아이디
                // weather 옷 계절
                // clothesType 아우터,상의,하의
                // clothesDetailType 가디건 가죽자켓 데님자켓 등등 디테일한 옷 종류
                RegisterClothesRequest registerClothesRequest = new RegisterClothesRequest(encoded_string, mImageCaptureName, userID, weather, clothesType ,clothesDetailType, responseListener);
